{
    ...
    for (const opName of [ "add", "subtract", "multiply", "divide", "percent" ]) {
        ...
        document.querySelector(`.op-cl__key[op=${opName}]`).onclick =
        opCallback(opName);

    }

    document.querySelector(".eq-cl__key").onclick = () => {
    ...
    document.querySelector(".op__key[op=clear]").oneclick = () => {
    ...
    document.querySelector(".op__key[op=negate]").onclick = () => ($input.value 
